...
## Pseudocode (PC) here ...
listofseeds <- c(423456, 144456, 523456, 166456, 124456,
                 993456, 123886, 157456, 123456, 123477)

# start somewhere the file you will write to with output

for (i in listofseeds){

start_time <- Sys.time()
# Fit model
testme <- stan("stan/uberspeed_oldfunctionnocholesky_withpriors.stan", # Or ubermini_2.stan
...
abline(a = 0, b = 1, lty = "dotted")
    ...
    # PC: somewhere here update your data frame
    }

# more PC ...
write.csv(outputfile, "uberspeed_oldfunctionnocholesky_withpriors.csv",
          row.names=FALSE)
