...
test <- stan("stan/phylogeny_synchrony_cholesky_geoffmod.stan",
...
summary(test)$summary[c("a_z","lam_interceptsa","sigma_interceptsa", "b_z","lam_interceptsbf","sigma_interceptsb","sigma_y"),"mean"]; t(param)
# 
 save(test, file = "output_phylo_cholesky_GeoffsModel.Rda")
